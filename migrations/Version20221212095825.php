 ...
 */
final class Version20221212095825 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE annonce_list_by_user ADD CONSTRAINT FK_81A4A15E4C2885D7 FOREIGN KEY (annonces_id) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
